...
<div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2em', alignItems: 'center', marginBottom: '2em' }}>
  ...
  <div style={{ textAlign: 'center' }}>
    <img src={require('../static/img/retrieval.png').default} alt="Retrieval" style={{ maxWidth: '100%', height: 'auto' }} />
  </div>
</div>
...
You can also upload data programmatically for automation:

```bash
curl -X POST https://<your-dify-instance>/v1/knowledge-bases/{kb_id}/documents \
  -H "Authorization: Bearer <your-api-key>" \
  -F "file=@REST_JiraEcosystem_issues.json"
```

Or use Python with the <code>requests</code> library.
