...
<div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2em', alignItems: 'center', marginBottom: '2em' }}>
  ...
  <div style={{ textAlign: 'center' }}>
    <img src={require('../static/img/generation.png').default} alt="Dify Instance Portal" style={{ maxWidth: '100%', borderRadius: '8px' }} />
  </div>
</div>
...
<div style={{ background: '#fffbe8', border: '2px solid #facc15', borderRadius: '8px', padding: '1em 1.5em', marginBottom: '2em' }}>
  ...
  👉 <a href="https://5xygt5eujjlo2p7umj2arir2du0ztioi.lambda-url.eu-west-3.on.aws/" target="_blank" rel="noopener noreferrer"><b>Launch your Dify instance</b></a>
</div>
...
<a
  href="/tp/dify-dsls/ex1_solved.yml"
  download
  style={{
    display: 'inline-flex',
    alignItems: 'center',
