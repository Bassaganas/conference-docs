...
<div style={{
  ...
  <h3 style={{ marginTop: 0, color: '#b45309' }}>🔍 <b>Try These Queries!</b></h3>
  <p style={{ fontWeight: 500, fontSize: '1.1em', marginBottom: '0.7em' }}>
    <b>Notice how having better data generates better results!</b> After uploading, go to <b>Retrieval testing</b> and try:
  </p>
  <ul style={{ fontSize: '1.05em' }}>
    <li>👉 <code>What is this issue about: Jira Issue: REST-259?</code></li>
  </ul>
  <p style={{ marginTop: '0.7em' }}>
    Compare the answers you get from structured JSON ingestion to those from manually ingested <code>.txt</code> files. <b>Structured data enables smarter, more accurate answers!</b>
  </p>
  <img src={require('../static/img/ex2/test-queries.png').default} alt="API Ingestion Endpoint" style={{ maxWidth: '100%', borderRadius: '8px', margin: '1em 0' }} />
</div>
