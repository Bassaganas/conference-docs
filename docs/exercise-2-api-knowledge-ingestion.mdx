...
**🔗 [API Documentation](https://dify-jira.testingfantasy.com/docs)**
...
```bash
curl -X GET "https://testus-patronus.testingfantasy.com/projects"
```
...
```bash
curl -X POST "https://testus-patronus.testingfantasy.com/jira/ingestion" \
