...
<ol style={{ marginBottom: '2em' }}>
  ...
  <li>
    Important: Select <b>Chatflow</b> this time, give it a meaningful name and description, and create it:<br />
  ...
  <li>
    Add a <b>Prompt</b> to the LLM block. Add both the query and context to the prompt!<br />
...
<div style={{ background: '#f3f0ff', border: '2px solid #7c3aed', borderRadius: '8px', padding: '0.8em 1.2em', margin: '1em 0' }}>
  <b>Ops! But does it really work already?</b>
</div>
...
## 🧙‍♂️ What if I missed a previous step?

<div style={{ background: '#e0f2fe', border: '2px solid #38bdf8', borderRadius: '8px', padding: '0.8em 1.2em', margin: '1em 0' }}>
  <ul>
    <li><b>Didn't finish Exercise 1?</b> Download the solution DSL below and import it into Dify.</li>
    <li><b>Didn't finish Exercise 2.1?</b> You can proceed with the manual knowledge base from Exercise 2, but for the best experience, try the API ingestion when you have time!</li>
  </ul>
</div>
