...
<div style={{ background: '#ecfdf5', border: '2px solid #22c55e', borderRadius: '8px', padding: '1em 1.5em', marginBottom: '2em' }}>
  <b>Release baseline:</b> Follow this API ingestion exercise against Dify <code>1.9.1</code>, the September 2025 legacy release. Use the Dify base URL shown in your assigned environment; the examples below intentionally use a synthetic placeholder. Release-matched UI screenshots are pending reviewed recapture.
</div>
