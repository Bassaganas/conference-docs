...
<div style={{ background: '#f3f0ff', border: '2px solid #7c3aed', borderRadius: '12px', padding: '1.5em', marginBottom: '2em' }}>
  ...
  <div style={{ background: '#e0f2fe', border: '1px solid #38bdf8', borderRadius: '6px', padding: '0.8em', marginTop: '1em', fontSize: '0.9em' }}>
    <b>⏱️ Estimated Time:</b> 10-15 minutes | <b>🎯 Goal:</b> API-ingested knowledge base with structured metadata
  </div>
</div>
...
## ✅ Step 4: Verify Ingestion in Dify
...
- a retrieval test for <code>Give a test plan for REST-266</code> returns the expected issue.
...
## 📚 Step 5: Compare Knowledge Base Approaches
