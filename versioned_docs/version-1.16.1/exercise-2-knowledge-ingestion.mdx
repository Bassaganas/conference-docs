...
<div style={{ background: '#e0f2fe', border: '2px solid #38bdf8', borderRadius: '8px', padding: '1em 1.2em', margin: '1em 0' }}>
  <b>Verify retrieval, not just indexing:</b> open <b>Retrieval Testing</b> and query <code>REST-266 Default Jackson configuration unknown properties</code>. A useful result contains the issue key, summary, and description in the same retrieved context.
</div>
